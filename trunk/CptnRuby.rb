...
class CptnRuby
  ...
  def initialize(window, x, y)
    ...
    @standing, @walk1, @walk2, @jump =
      *Image.load_tiles(window, "CptnRuby.png", 50, 50, false)
...
class Map
  ...
  def initialize(window, filename)
    ...
    @tileset = Image.load_tiles(window, "CptnRuby Tileset.png", 60, 60, true)
    @sky = Image.new(window, "Space.png", true)

    gem_img = Image.new(window, "CptnRuby Gem.png", false)
    @gems = []
